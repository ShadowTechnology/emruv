        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="smallModalLabel">Bank</h4>
                </div>
                ...
                columns: [
                    ...
                    { data: 'status'},
                    {
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            return '<a href="#" onclick="loadBank('+tid+')" title="Edit Bank"><i class="ft-edit"></i></a>';
                            @else 
                            return '';
                            @endif
                        },

        ...
        <div class="container-fluid">
            ...
            <form id="user-form"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Update Servicer Status</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <div class="form-group">
                                <label>Servicer Active/ In Avtive</label>
                ...
                <div style="margin: auto;padding: 10px;">
                    ...
                    <button type="submit" class="btn btn-info mb-3" id="edit-user">Submit</button>
                    @else 
                    <span style="color:red">Documents are Not Approved. Please check and Update.</span>
                    @endif
                    <br/>

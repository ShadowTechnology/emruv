...
class CommonController extends Controller
{
    ...
    $url = "https://apps.gateway.sa/vendorsms/pushsms.aspx?user=hurrybunny&password=q1w2e3r4&msisdn=$mobile_no&sid=HURRY BUNNY&msg=$message&fl=0";
 ...
 //   $url = "https://www.paytabs.com/apiv2/refund_process";
    /*    $ch = curl_init();
        ...
        curl_close($ch);
*/
    //    echo "<pre>"; print_r($response);print_r($err);  
